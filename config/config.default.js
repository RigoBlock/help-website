...
var config = {
  ...
  site_title: 'RigoBlock Knowledge Base',

  // The base URL of your site (can use %base_url% in Markdown files)
  base_url: '',

  // Used for the "Get in touch" page footer link
  support_email: 'david@rigoblock.com',

  // Footer Text / Copyright
  copyright: 'Copyright &copy; ' + new Date().getFullYear() + ' - <a href="http://www.rigoblock.com">Powered by RigoBlock</a>',
  ...
  public_dir: path.join(__dirname, '..', 'themes', 'rigoblock', 'public'),
